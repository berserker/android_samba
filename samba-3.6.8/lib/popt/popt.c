...
// Berserker - begin: questo file sembra non includere "includes.h" (che include config.h), HAVE_FLOAT_H risulta quindi non settata e di conseguenza da errore di compilazione su DBL_EPSILON
#include "config.h"
// Berserker - end
